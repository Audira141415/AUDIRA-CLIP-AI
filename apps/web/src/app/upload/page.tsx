  ...
  const handleSubmit = async () => {
    ...
    try {
      if (importMode === 'LOCAL' && file) {
        ...
        const res = await fetch(`http://localhost:3001/video/upload?userId=${userId}&workspaceId=${workspaceId}&aspects=${aspect}&intent=${intent}&lang=${lang}&captions=${enableCaptions}&broll=${enableBroll}&layoutMode=${layoutMode}`, {
          method: 'POST',
          body: formData,
        });
        ...
        const res = await fetch(`http://localhost:3001/video/import-url?url=${encodeURIComponent(urlToProcess)}&userId=${userId}&workspaceId=${workspaceId}&aspects=${aspect}&intent=${intent}&layoutMode=${layoutMode}`, {
          method: 'POST',
        });
  ...
  return (
    <DashboardLayout>
      <div className="flex-1 bg-background min-h-screen text-black font-sans p-8">
        ...
        <h1 className="text-5xl font-heading font-black uppercase tracking-tight mb-8">Tambah Video Baru</h1>
          ...
          <div className="bg-primary border-4 border-black shadow-neu p-6 flex flex-col h-fit">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3 pt-2">
                <label className="flex items-center gap-3 cursor-pointer p-3 bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:bg-secondary transition-colors">
                ...
                <label className="flex items-center gap-3 cursor-pointer p-3 bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:bg-accent-teal transition-colors">
